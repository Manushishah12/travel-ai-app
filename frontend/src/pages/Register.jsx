    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f3efe8] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#8a8278] mt-2 text-sm">Create your account</p>
        </div>
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium text-[#5c564f] mb-1">Name</label>
            <input
              type="text"
              required
              minLength={2}
          ...
          <p className="text-center text-sm text-[#8a8278]">
            ...
            <Link to="/login" className="text-[#3b6ea8] font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </form>
